require("plenary.reload").reload_module("zecolor", true)
local zecolor = require("zecolor")
local default = zecolor.config
...
describe("tests", function()
  it("works with default values", function()
    zecolor.setup()
    assert.are.same(zecolor.config, default)
  end)
  ...
  it("does not set terminal colors when terminal_colors is false", function()
    clear_term_colors()
    zecolor.setup({ terminal_colors = false })
    zecolor.load()
  ...
  it("sets terminal colors when terminal_colors is true", function()
    clear_term_colors()
    zecolor.setup({ terminal_colors = true })
    zecolor.load()

    -- dark bg
    local colors = require("zecolor").palette
